...
namespace ManutationItemsApp.DAL.Migrations
{
    ...
    [Migration("20200529145404_new manutation")]
    partial class newmanutation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManutationItemsApp.Domain.Entities.TestManutation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ManutationItemsApp.Domain.Entities.Item", b =>
                {
                    b.HasOne("ManutationItemsApp.Domain.Entities.ItemType", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("ManutationItemsApp.Domain.Entities.ManutationStage", b =>
                {
                    b.HasOne("ManutationItemsApp.Domain.Entities.Manutation", null)
                        .WithMany("ManutationStages")
                        .HasForeignKey("ManutationId");

                    b.HasOne("ManutationItemsApp.Domain.Entities.NewManutation", "Manutation")
                        .WithMany("ManutationStages")
                        .HasForeignKey("ManutationId1");
                });
